...
class LotoApp:
    def __init__(self, master=None):
        ...
        self.entry1.grid(column=0, ipadx=5, pady=5, row=0)
        ...
        self.entry6.grid(column=2, row=1)
